...
$eltdf_rev_style = array();

if ( $enable_paspartu === 'yes' ) {
	$css_class .= ' eltdf-rev-has-paspartu';
	
	if ( ! empty( $paspartu_size ) ) {
		$css_class .= ' eltdf-paspartu-' . $paspartu_size;
	}
	
	if ( $disable_side_paspartu === 'yes' ) {
		$css_class .= ' eltdf-side-paspartu-disabled';
	}
	
	if ( $disable_top_paspartu === 'yes' ) {
		$css_class .= ' eltdf-top-paspartu-disabled';
	}
}
