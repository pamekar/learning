...
if (!class_exists('AcademistElatedClassFullscreenNavigationWalker')) {
	class AcademistElatedClassFullscreenNavigationWalker extends Walker_Nav_Menu {
...
//					$item_output .= '<i class="eltdf-fullscreen-menu-arrow"></i>';
//				}
				$item_output .= '</span></a>';
			}
