<?php
namespace AcademistCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'academist' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Boxed', 'academist' )    => 'boxed',
							esc_html__( 'Masonry', 'academist' )  => 'masonry',
							esc_html__( 'Minimal', 'academist' )  => 'minimal'
						),
						'save_always' => true
					),
                    array(
                        'type'       => 'dropdown',
                        'param_name' => 'skin',
                        'heading'    => esc_html__('Skin', 'academist'),
                        'value'      => array(
                            esc_html__('Default', 'academist') => '',
                            esc_html__('Light', 'academist')   => 'light',
                        ),
                        'dependency'  => Array( 'element' => 'type', 'value' => array('standard', 'masonry', 'minimal')),
                        'save_always' => true
                    ),
					array(
						'type'       => 'textfield',
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'academist' ),
						'description' => esc_html__( 'Number of words', 'academist' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'academist' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Read More', 'academist' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'academist' ),
						'value'      => array_flip( academist_elated_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'academist' )
					),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'academist' ),
						'value'      => array_flip( academist_elated_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'academist' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'academist' ),
						'value'      => array_flip( academist_elated_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'academist' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'post_info_tag',
						'heading'    => esc_html__( 'Enable Post Info Tag', 'academist' ),
						'value'      => array_flip( academist_elated_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'academist' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'academist' ),
						'value'      => array(
							esc_html__( 'None', 'academist' )            => 'no-pagination',
							esc_html__( 'Standard', 'academist' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'academist' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'academist' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'academist' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		academist_elated_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	public function getHolderClasses( $params, $default_atts ) {
        ...
        $holderClasses[] = $params['skin'] === 'light' ? 'eltdf-light-skin' : '';
