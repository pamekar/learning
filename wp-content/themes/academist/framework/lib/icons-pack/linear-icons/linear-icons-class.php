...
if ( ! function_exists( 'academist_elated_add_linear_icon_pack' ) ) {
	function academist_elated_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new AcademistElatedClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_collection', 'academist_elated_add_linear_icon_pack' );
}

if ( ! function_exists( 'academist_elated_add_linear_icon_pack_option' ) ) {
	function academist_elated_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'academist' );
		
		return $options;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_options', 'academist_elated_add_linear_icon_pack_option' );
}

class AcademistElatedClassLinearIcons implements iAcademistElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = ELATED_FRAMEWORK_ICONS_ROOT . '/linear-icons/style.css';
	}
