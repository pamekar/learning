...
if ( ! function_exists( 'academist_elated_add_linea_icon_pack' ) ) {
	function academist_elated_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new AcademistElatedClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_collection', 'academist_elated_add_linea_icon_pack' );
}

if ( ! function_exists( 'academist_elated_add_linea_icon_pack_option' ) ) {
	function academist_elated_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'academist' );
		
		return $options;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_options', 'academist_elated_add_linea_icon_pack_option' );
}

class AcademistElatedClassLineaIcons implements iAcademistElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = ELATED_FRAMEWORK_ICONS_ROOT . '/linea-icons/style.css';
	}
