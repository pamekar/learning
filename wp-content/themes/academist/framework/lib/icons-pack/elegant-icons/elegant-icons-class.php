...
if ( ! function_exists( 'academist_elated_add_font_elegant_icon_pack' ) ) {
	function academist_elated_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new AcademistElatedClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_collection', 'academist_elated_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'academist_elated_add_font_elegant_icon_pack_option' ) ) {
	function academist_elated_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'academist' );
		
		return $options;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_options', 'academist_elated_add_font_elegant_icon_pack_option' );
	add_filter( 'academist_elated_filter_add_icon_pack_into_social_options', 'academist_elated_add_font_elegant_icon_pack_option' );
}

class AcademistElatedClassIconsFontElegant implements iAcademistElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = ELATED_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
	...
	public function getFullScreenMenuIcon() {
	...
	public function getMenuIcon() {
		...
		return $this->render('icon_menu-square_alt2');
	}
