...
if ( ! function_exists( 'academist_elated_add_dripicons_icon_pack' ) ) {
	function academist_elated_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new AcademistElatedClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_collection', 'academist_elated_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'academist_elated_add_dripicons_icon_pack_option' ) ) {
	function academist_elated_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'academist' );
		
		return $options;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_options', 'academist_elated_add_dripicons_icon_pack_option' );
}

class AcademistElatedClassDripicons implements iAcademistElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->param = $param;
        $this->setIconsArray();
        $this->styleUrl = ELATED_FRAMEWORK_ICONS_ROOT . '/dripicons/dripicons.css';
    }
