...
if ( ! function_exists( 'academist_elated_add_simple_line_icon_pack' ) ) {
	function academist_elated_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new AcademistElatedClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_collection', 'academist_elated_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'academist_elated_add_simple_line_icon_pack_option' ) ) {
	function academist_elated_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'academist' );
		
		return $options;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_options', 'academist_elated_add_simple_line_icon_pack_option' );
	add_filter( 'academist_elated_filter_add_icon_pack_into_social_options', 'academist_elated_add_simple_line_icon_pack_option' );
}

class AcademistElatedClassSimpleLineIcons implements iAcademistElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = ELATED_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'academist'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'academist'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'academist'),
            'icon-social-facebook'    => esc_html__('Facebook', 'academist'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'academist'),
            'icon-social-github'      => esc_html__('Github', 'academist'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'academist'),
            'icon-social-instagram'   => esc_html__('Instagram', 'academist'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'academist'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'academist'),
            'icon-social-reddit'      => esc_html__('Reddit', 'academist'),
            'icon-social-skype'       => esc_html__('Skype', 'academist'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'academist'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'academist'),
            'icon-social-spotify'     => esc_html__('Spotify', 'academist'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'academist'),
            'icon-social-twitter'     => esc_html__('Twitter', 'academist'),
            'icon-social-youtube'     => esc_html__('Youtube', 'academist')
        );
    }
