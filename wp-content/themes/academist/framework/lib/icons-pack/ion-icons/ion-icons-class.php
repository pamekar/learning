...
if ( ! function_exists( 'academist_elated_add_ion_icon_pack' ) ) {
	function academist_elated_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new AcademistElatedClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_collection', 'academist_elated_add_ion_icon_pack' );
}

if ( ! function_exists( 'academist_elated_add_ion_icon_pack_option' ) ) {
	function academist_elated_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'academist' );
		
		return $options;
	}
	
	add_filter( 'academist_elated_filter_add_icon_pack_into_options', 'academist_elated_add_ion_icon_pack_option' );
	add_filter( 'academist_elated_filter_add_icon_pack_into_social_options', 'academist_elated_add_ion_icon_pack_option' );
}

class AcademistElatedClassIonIcons implements iAcademistElatedInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = ELATED_FRAMEWORK_ICONS_ROOT . '/ion-icons/css/ionicons.min.css';
	}
