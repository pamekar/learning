...
namespace AcademistMembership\Lib;

/**
 * Class ShortcodeLoader
 * @package AcademistMembership\Lib
 */
class ShortcodeLoader {
	/**
	...
	private function addShortcodes() {
		$shortcodes_class_name = apply_filters( 'academist_membership_filter_add_vc_shortcode', $shortcodes_class_name = array() );
