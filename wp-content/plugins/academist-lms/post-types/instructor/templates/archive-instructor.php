...
<div class="eltdf-container eltdf-default-page-template">
	...
	<div class="eltdf-container-inner clearfix">
		...
		$academist_taxonomy      = ! empty( $academist_taxonomy_id ) ? get_term_by( 'id', $academist_taxonomy_id, 'instructor-category' ) : '';
		$academist_taxonomy_slug = ! empty( $academist_taxonomy ) ? $academist_taxonomy->slug : '';
		
		academist_lms_get_instructor_category_list( $academist_taxonomy_slug );
		?>
	</div>
