<?php
namespace AcademistCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'academist-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'academist-core' ) => 'accordion',
								esc_html__( 'Toggle', 'academist-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
							...
							'value'      => array(
								esc_html__( 'Boxed', 'academist-core' )  => 'boxed',
						...
						array(
							...
							'heading'    => esc_html__( 'Background Skin', 'academist-core' ),
							'value'      => array(
								esc_html__( 'Default', 'academist-core' ) => '',
								esc_html__( 'White', 'academist-core' )   => 'white'
							),
	...
	public function render( $atts, $content = null ) {
		...
		$output = academist_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );
