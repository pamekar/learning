<?php
namespace AcademistCore\CPT\Shortcodes\Banner;
...
class Banner implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Banner', 'academist-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Overlay Color', 'academist-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hover_behavior',
							'heading'     => esc_html__( 'Hover Behavior', 'academist-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'academist-core' )   => 'eltdf-visible-on-hover',
								esc_html__( 'Visible on Default', 'academist-core' ) => 'eltdf-visible-on-default',
								esc_html__( 'Disabled', 'academist-core' )           => 'eltdf-disabled'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Position', 'academist-core' ),
							'value'       => array(
								esc_html__( 'Default', 'academist-core' )  => 'default',
								esc_html__( 'Centered', 'academist-core' ) => 'centered'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Content Padding', 'academist-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left', 'academist-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
						...
						array(
							...
							'heading'     => esc_html__( 'Subtitle Tag', 'academist-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Subtitle Color', 'academist-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Link Text', 'academist-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'link_color',
							'heading'    => esc_html__( 'Link Text Color', 'academist-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'link_top_margin',
							'heading'    => esc_html__( 'Link Text Top Margin (px)', 'academist-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		$args   = array(
			...
			'image'                => '',
			'overlay_color'        => '',
			'hover_behavior'       => 'eltdf-visible-on-hover',
		...
		$html = academist_core_get_shortcode_module_template_part( 'templates/banner', 'banner', '', $params );
	...
	private function getHolderClasses( $params, $args ) {
		...
		$holderClasses[] = ! empty( $params['info_position'] ) ? 'eltdf-banner-info-' . $params['info_position'] : 'eltdf-banner-info-' . $args['info_position'];
	...
	private function getLinkStyles( $params ) {
		...
		if ( ! empty( $params['link_top_margin'] ) ) {
			$styles[] = 'margin-top: ' . academist_elated_filter_px( $params['link_top_margin'] ) . 'px';
		}
