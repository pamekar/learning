...
class TeamSlider implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
	    if(function_exists('vc_map')) {
		    vc_map(
		    	array(
				    'name'                      => esc_html__( 'Team Slider', 'academist-core' ),
				    'base'                      => $this->base,
				    ...
				    'params'                    => array(
					    array(
						    ...
						    'heading'     => esc_html__( 'Number of Columns in Row', 'academist-core' ),
						    'value'       => array_flip( academist_elated_get_number_of_columns_array( false ) ),
						    'save_always' => true
					    ),
                        array(
                            'type'        => 'dropdown',
