...
namespace AcademistCore\CPT;

use AcademistCore\Lib;

/**
 * Class PostTypesLoader
 * @package AcademistCore\CPT
 */
class PostTypesRegister {
	...
	private function addPostTypes() {
		$cpt_class_name = apply_filters( 'academist_core_filter_register_custom_post_types', $cpt_class_name = array() );
