...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'academist-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'academist-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Type', 'academist-core' ),
							'value'       => array(
								esc_html__( 'Title', 'academist-core' )          => 'title',
								esc_html__( 'Category', 'academist-core' )       => 'category',
								esc_html__( 'Tag', 'academist-core' )            => 'tag',
								esc_html__( 'Author', 'academist-core' )         => 'author',
								esc_html__( 'Date', 'academist-core' )           => 'date',
								esc_html__( 'Featured Image', 'academist-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'academist-core' ),
							'value'       => array_flip( academist_elated_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'academist-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'academist-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'academist-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'academist-core' ),
							'value'      => array_flip( academist_elated_get_title_tag( true, array( 'p' => 'p' ) ) ),
