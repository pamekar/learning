<?php
if ( ! function_exists( 'academist_elated_init_google_fonts_array' ) ) {
    function academist_elated_init_google_fonts_array() {
        ...
        $academist_elated_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'academist_elated_init_google_fonts_array');
}