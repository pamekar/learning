 ...
 * @author   WooThemes
 */
abstract class WC_Elatedf_Data_Store_CPT extends WC_Data_Store_WP implements WC_Object_Data_Store_Interface, WC_Product_Data_Store_Interface {
    ...
    */
    ...
    protected function read_product_data( &$product ) {
        ...
        if ( $product->is_type( $this->custom_post_type ) && $product->is_on_sale( 'edit' ) && $product->get_sale_price( 'edit' ) !== $product->get_price( 'edit' ) ) {
    ...
    */
    ...
    public function get_on_sale_products() {
        ...
        return $wpdb->get_results( "
			...
			WHERE post.post_type IN ( $this->custom_post_type )
    ...
    public function is_existing_sku( $product_id, $sku ) {
        ...
        return $wpdb->get_var( $wpdb->prepare( "
			...
			WHERE $wpdb->posts.post_type IN ( $this->custom_post_type )
    ...
    public function get_product_id_by_sku( $sku ) {
        ...
        $id = $wpdb->get_var( $wpdb->prepare( "
			...
			WHERE posts.post_type IN ( $this->custom_post_type )
    ...
    public function get_related_products_query( $cats_array, $tags_array, $exclude_ids, $limit ) {
        ...
        $query = array(
            ...
            'where'  => "
				...
				AND p.post_type = $this->custom_post_type
    ...
    public function search_products( $term, $type = '', $include_variations = false ) {
        ...
        $post_types    = $this->custom_post_type;
        ...
        if ( is_numeric( $term ) ) {
            ...
            if ( 'product_variation' === $post_type && $include_variations ) {
                $product_ids[] = $post_id;
            } elseif ( $this->custom_post_type === $post_type ) {
                $product_ids[] = $post_id;
            }
    ...
    public function query( $query_vars ) {
        ...
        if ( isset( $query_vars['return'] ) && 'objects' === $query_vars['return'] && ! empty( $query->posts ) ) {
            ...
            update_post_caches( $query->posts, array( $this->custom_post_type ) );
        }
