...
include 'academist-instagram-helper.php';

/**
 * Class AcademistInstagramApi
 */
class AcademistInstagramApi {
	/**
	...
	private $apiURL;
	/**
	 * @var AcademistInstagramApi instance of current class
	 */
	private static $instance;
	
	/**
	 * Helper object
	 * @var AcademistInstagramHelper
	 */
	private $helper;
	
	const CODE_OPTION_NAME = 'academist_instagram_code';
	const USER_ID_OPTION_NAME = 'academist_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'academist_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'academist_instagram_code_redirect_uri';
	...
	public function __construct() {
		...
		$this->redirectUri  = defined( 'ELATED_PROFILE_SLUG' ) ? 'http://demo.' . ELATED_PROFILE_SLUG . '-themes.com/instagram-app/instagram-redirect.php' : '';
		...
		$this->helper       = new AcademistInstagramHelper();
	}
	 ...
	 * @return string
	 *
	 * @see AcademistInstagramApi::buildCurrentPageURI()
	 */
	...
	/**
	 * @return AcademistInstagramHelper
	 */
	 ...
	 *
	 * @see AcademistInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see AcademistInstagramApi::getAccessToken()
	 */
