...
/**
 * Class AcademistInstagramHelper
 */
class AcademistInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines academist_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image, $imageSize ) {
		...
		$imageAtts = apply_filters( 'academist_instagram_image_atts',
			array(
				'class'  => $imageSize,
